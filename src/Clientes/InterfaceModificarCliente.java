...
public class InterfaceModificarCliente extends javax.swing.JFrame {
     ...
     */
    public InterfaceModificarCliente() {
        initComponents();
    ...
    public InterfaceModificarCliente(Operaciones op) {
        initComponents();
        setLocationRelativeTo(null);//permite que la ventana aparezca centrada
        setResizable(false); // permite que la ventana no se pueda maximizar
        setTitle("Modificar Cliente");
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        if(lstClientes.getSelectedIndex() == -1){
            ...
            InterfaceModificarClienteDatos imcd = new InterfaceModificarClienteDatos(op);
