 ...
 * @author luis
 */
public class InterfaceModificarSuper extends javax.swing.JFrame {
     ...
     */
    public InterfaceModificarSuper() {
        initComponents();
    ...
    public InterfaceModificarSuper(Operaciones op) {
        initComponents();
        setLocationRelativeTo(null);//permite que la ventana aparezca centrada
        setResizable(false); // permite que la ventana no se pueda maximizar
        setTitle("Modificar Usuario");
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        if(lstSupermercado.getSelectedIndex() == -1){
            ...
            InterfaceModificarSuperDatos imsd = new InterfaceModificarSuperDatos(op);
            imsd.setVisible(true);
            dispose();
        }
